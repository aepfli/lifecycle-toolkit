...
* add validating webhook for Keptn Metrics ([#668](https://github.com/aepfli/lifecycle-toolkit/issues/668)) ([a4cc579](https://github.com/aepfli/lifecycle-toolkit/commit/a4cc579b91a6156604b33a86f53af287cabd2989))
...
* Move dashboards and fix issues ([#417](https://github.com/aepfli/lifecycle-toolkit/issues/417)) ([f6b5bfc](https://github.com/aepfli/lifecycle-toolkit/commit/f6b5bfcd0f3254970101c3ac53bdec8d1426b3de))
...
* **operator:** Add Spans for handling webhook requests and inject TraceContext ([#115](https://github.com/aepfli/lifecycle-toolkit/issues/115)) ([812f2c5](https://github.com/aepfli/lifecycle-toolkit/commit/812f2c5d49314617cb9c7532262e15edecd9f078))
...
* **operator:** Bootstrap evaluation CRD from WorkloadInstance ([#188](https://github.com/aepfli/lifecycle-toolkit/issues/188)) ([95e206b](https://github.com/aepfli/lifecycle-toolkit/commit/95e206b4165b0277f5acbc67fc78a8e28f06741b))
...
* **operator:** Refactor metrics helper functions ([#269](https://github.com/aepfli/lifecycle-toolkit/issues/269)) ([b6f3f43](https://github.com/aepfli/lifecycle-toolkit/commit/b6f3f43e29737839b25fea16c7b3810f193b313f))
...
* add example release logic ([34e634d](https://github.com/aepfli/lifecycle-toolkit/commit/34e634d711b73f653776fc9fc598391e9f2bfc7c))
...
* include namespace creation in release manifest ([#855](https://github.com/aepfli/lifecycle-toolkit/issues/855)) ([d7a2b48](https://github.com/aepfli/lifecycle-toolkit/commit/d7a2b486dd90ff173edbab49ff59988d58cc53c1))
...
* **operator:** Get desired amount of replicas from upper level resource ([#89](https://github.com/aepfli/lifecycle-toolkit/issues/89)) ([6767832](https://github.com/aepfli/lifecycle-toolkit/commit/67678327c2531c25ea0cdb6f1b805365ae454719))
...
* **operator:** prevent re-execution of workload tasks that have been cancelled in a previous KLT version ([#718](https://github.com/aepfli/lifecycle-toolkit/issues/718)) ([d89e179](https://github.com/aepfli/lifecycle-toolkit/commit/d89e17909d9294dc172b62c621cfb8edf2eef533))
...
* **operator:** Update workload if spec changes ([#90](https://github.com/aepfli/lifecycle-toolkit/issues/90)) ([ec01ad2](https://github.com/aepfli/lifecycle-toolkit/commit/ec01ad2ccd04f0c4e6f9ba47e01c5bada128aa3b))
* **operator:** Update workload instance controller, add example ([#102](https://github.com/aepfli/lifecycle-toolkit/issues/102)) ([e679c10](https://github.com/aepfli/lifecycle-toolkit/commit/e679c1070f0130bd2d6616bf1856956e64dc0bac))
...
* Prepare release ([#110](https://github.com/aepfli/lifecycle-toolkit/issues/110)) ([9d7644b](https://github.com/aepfli/lifecycle-toolkit/commit/9d7644b718e29bd37da398d89dc8b51997667358))


### Build

* Prepare release ([#149](https://github.com/aepfli/lifecycle-toolkit/issues/149)) ([5be4504](https://github.com/aepfli/lifecycle-toolkit/commit/5be4504e365b1c89ffc3069871a3f0fc0ecc7482))
...
* Adjust conventional commit configuration ([#103](https://github.com/aepfli/lifecycle-toolkit/issues/103)) ([1d89b46](https://github.com/aepfli/lifecycle-toolkit/commit/1d89b46050cb019614eb36549691e3164797a238))
...
* Clean up release-please manifest file ([#108](https://github.com/aepfli/lifecycle-toolkit/issues/108)) ([43ce011](https://github.com/aepfli/lifecycle-toolkit/commit/43ce0116e4173c5aa2d659deb3eca3b9460f474b))
...
* improve Makefiles usage ([#921](https://github.com/aepfli/lifecycle-toolkit/issues/921)) ([2761a4d](https://github.com/aepfli/lifecycle-toolkit/commit/2761a4dad36f452b2dd575ab5ec1572b68602165))
...
* **main:** release 0.1.0 ([#85](https://github.com/aepfli/lifecycle-toolkit/issues/85)) ([ead06ed](https://github.com/aepfli/lifecycle-toolkit/commit/ead06edf248d6883b180adf002c22619e0e36b4b))
...
* **scheduler:** make RealAnna codeowner ([#369](https://github.com/aepfli/lifecycle-toolkit/issues/369)) ([aba0a70](https://github.com/aepfli/lifecycle-toolkit/commit/aba0a708c3aace2d2309fa571e073d90ad6d6861))
...
* update denoland/deno docker tag to v1.27.2 ([#354](https://github.com/aepfli/lifecycle-toolkit/issues/354)) ([3a37846](https://github.com/aepfli/lifecycle-toolkit/commit/3a37846f1d0654798acaf626487d3903d824f7fc))
...
* update dependency cert-manager/cert-manager to v1.11.0 ([#627](https://github.com/aepfli/lifecycle-toolkit/issues/627)) ([8720282](https://github.com/aepfli/lifecycle-toolkit/commit/8720282a9c9817976d75457de392b7bd9989ca72))
...
* update dependency pyyaml to v6 ([#648](https://github.com/aepfli/lifecycle-toolkit/issues/648)) ([850cf7a](https://github.com/aepfli/lifecycle-toolkit/commit/850cf7a8e32f31f02bb3fd2cdc879293b062a432))
...
* update jasonetco/create-an-issue action to v2.9.1 ([#557](https://github.com/aepfli/lifecycle-toolkit/issues/557)) ([f6d5934](https://github.com/aepfli/lifecycle-toolkit/commit/f6d59345f3954673122097e686e769c3a1ed14e9))
...
* update module github.com/onsi/ginkgo/v2 to v2.8.1 ([#867](https://github.com/aepfli/lifecycle-toolkit/issues/867)) ([4c36b48](https://github.com/aepfli/lifecycle-toolkit/commit/4c36b483ecacfb8639d26cde4cc0cf88bbb34826))
...
* update module github.com/prometheus/client_golang to v1.14.0 ([#395](https://github.com/aepfli/lifecycle-toolkit/issues/395)) ([39af17b](https://github.com/aepfli/lifecycle-toolkit/commit/39af17bb9e7d1827edb27dd1d8130a2152332cde))
* update module github.com/prometheus/common to v0.37.1 ([#533](https://github.com/aepfli/lifecycle-toolkit/issues/533)) ([b72d52e](https://github.com/aepfli/lifecycle-toolkit/commit/b72d52eb1e940247f4accbf7e883edcf965dbd52))
* update module github.com/prometheus/common to v0.39.0 ([#502](https://github.com/aepfli/lifecycle-toolkit/issues/502)) ([28ab629](https://github.com/aepfli/lifecycle-toolkit/commit/28ab6292d5c06e328f57794e0c309ef0b124f9d5))
* update module github.com/prometheus/common to v0.40.0 ([#907](https://github.com/aepfli/lifecycle-toolkit/issues/907)) ([d90355d](https://github.com/aepfli/lifecycle-toolkit/commit/d90355d54c5af8ca4ce3d3fc9036e966dba65314))
* update module github.com/spf13/afero to v1.9.3 ([#654](https://github.com/aepfli/lifecycle-toolkit/issues/654)) ([2831566](https://github.com/aepfli/lifecycle-toolkit/commit/283156638a960725e8bcbc11ae82277f930c9398))
* update module github.com/spf13/afero to v1.9.4 ([#911](https://github.com/aepfli/lifecycle-toolkit/issues/911)) ([36cfe90](https://github.com/aepfli/lifecycle-toolkit/commit/36cfe909611edc168824a7f570bed73f4c019264))
* update module github.com/stretchr/testify to v1.8.1 ([#551](https://github.com/aepfli/lifecycle-toolkit/issues/551)) ([523bb55](https://github.com/aepfli/lifecycle-toolkit/commit/523bb5520e81ce4078188c744b54ca5c9a79212e))
* update module google.golang.org/grpc to v1.50.1 ([#274](https://github.com/aepfli/lifecycle-toolkit/issues/274)) ([44ac9b4](https://github.com/aepfli/lifecycle-toolkit/commit/44ac9b4cf020043b5bee4e4d69ed3a9a27565353))
* update module google.golang.org/grpc to v1.51.0 ([#451](https://github.com/aepfli/lifecycle-toolkit/issues/451)) ([3828ee5](https://github.com/aepfli/lifecycle-toolkit/commit/3828ee58a1737694f93072208f54229d6f0fae8e))
* update module google.golang.org/grpc to v1.52.0 ([#626](https://github.com/aepfli/lifecycle-toolkit/issues/626)) ([ba65776](https://github.com/aepfli/lifecycle-toolkit/commit/ba657761fcecd1e52835e5e5d27a785329b597c4))
* update module google.golang.org/grpc to v1.52.3 ([#711](https://github.com/aepfli/lifecycle-toolkit/issues/711)) ([6c3009d](https://github.com/aepfli/lifecycle-toolkit/commit/6c3009dfb39ade9d2cc765f0897687e98571a19e))
* update module google.golang.org/grpc to v1.53.0 ([#817](https://github.com/aepfli/lifecycle-toolkit/issues/817)) ([f5a3493](https://github.com/aepfli/lifecycle-toolkit/commit/f5a3493545f391112f341b5c54b6bdf442d8179b))
* update module k8s.io/api to v0.25.5 ([#573](https://github.com/aepfli/lifecycle-toolkit/issues/573)) ([5159a5e](https://github.com/aepfli/lifecycle-toolkit/commit/5159a5e1d9aa774b719e2744b2d264b3559f8467))
* update module k8s.io/component-helpers to v0.25.5 ([#504](https://github.com/aepfli/lifecycle-toolkit/issues/504)) ([02b5982](https://github.com/aepfli/lifecycle-toolkit/commit/02b59826329a70742dd39edcb9c3a32ba86b0a6b))
* update module k8s.io/component-helpers to v0.25.6 ([#676](https://github.com/aepfli/lifecycle-toolkit/issues/676)) ([bda60c8](https://github.com/aepfli/lifecycle-toolkit/commit/bda60c8301ce7cc247c3748fa25304c284750f75))
* update module k8s.io/klog/v2 to v2.90.0 ([#685](https://github.com/aepfli/lifecycle-toolkit/issues/685)) ([98164ed](https://github.com/aepfli/lifecycle-toolkit/commit/98164ed938a4f247a892e1ebf1a47bb0e5af1f67))
* update module k8s.io/klog/v2 to v2.90.1 ([#982](https://github.com/aepfli/lifecycle-toolkit/issues/982)) ([90052bc](https://github.com/aepfli/lifecycle-toolkit/commit/90052bc059af2d67f1835fe5ba72b5fa3eb77941))
* update module k8s.io/kubernetes to v1.25.4 ([#399](https://github.com/aepfli/lifecycle-toolkit/issues/399)) ([5f47086](https://github.com/aepfli/lifecycle-toolkit/commit/5f47086da4c38eb77cd8a009ae8cdb93bbc645b2))
* update module k8s.io/kubernetes to v1.25.5 ([#501](https://github.com/aepfli/lifecycle-toolkit/issues/501)) ([df8e51c](https://github.com/aepfli/lifecycle-toolkit/commit/df8e51c13a5a9b88bd96b67add713251682b274e))
* update module sigs.k8s.io/controller-runtime to v0.13.1 ([#279](https://github.com/aepfli/lifecycle-toolkit/issues/279)) ([3afcaad](https://github.com/aepfli/lifecycle-toolkit/commit/3afcaad7a560162f154f6002eb381d2df7690de7))
* update module sigs.k8s.io/controller-runtime to v0.13.1 ([#306](https://github.com/aepfli/lifecycle-toolkit/issues/306)) ([a3a0600](https://github.com/aepfli/lifecycle-toolkit/commit/a3a0600f59983d6f6ab000088dfbff54ff88eb67))
* update module sigs.k8s.io/controller-runtime to v0.14.2 ([#723](https://github.com/aepfli/lifecycle-toolkit/issues/723)) ([31fac62](https://github.com/aepfli/lifecycle-toolkit/commit/31fac62d81e67354235f55b40ecdfc921a75b265))
* update module sigs.k8s.io/controller-runtime to v0.14.3 ([#762](https://github.com/aepfli/lifecycle-toolkit/issues/762)) ([37e783e](https://github.com/aepfli/lifecycle-toolkit/commit/37e783ee09107a9eac0d1e0392fb4958d63355d4))
* update module sigs.k8s.io/controller-runtime to v0.14.4 ([#811](https://github.com/aepfli/lifecycle-toolkit/issues/811)) ([0191385](https://github.com/aepfli/lifecycle-toolkit/commit/0191385137751d8cc3b4b3a2fe35403fe2ad5771))
* update opentelemetry-go monorepo to v0.34.0 (minor) ([#498](https://github.com/aepfli/lifecycle-toolkit/issues/498)) ([e7db4d0](https://github.com/aepfli/lifecycle-toolkit/commit/e7db4d099f1586498f16047c3d0669cdb9a88147))
* update sigstore/cosign-installer action to v3 ([#973](https://github.com/aepfli/lifecycle-toolkit/issues/973)) ([e92259a](https://github.com/aepfli/lifecycle-toolkit/commit/e92259a26da97f5b9f3e8cdcdb8797e254430abf))
...
* add docs publishing information ([#949](https://github.com/aepfli/lifecycle-toolkit/issues/949)) ([4351e18](https://github.com/aepfli/lifecycle-toolkit/commit/4351e18c4097370520e63e48b947200a210f5380))
...
* Add proper version badge in readme ([#114](https://github.com/aepfli/lifecycle-toolkit/issues/114)) ([e4add2d](https://github.com/aepfli/lifecycle-toolkit/commit/e4add2de2340f160fe30bd0cd6831107339b175e))
...
* fix build status readme badge ([#590](https://github.com/aepfli/lifecycle-toolkit/issues/590)) ([88e7ac4](https://github.com/aepfli/lifecycle-toolkit/commit/88e7ac49eb3876b352f2418c853d9f306cf59386))
...
* Improve podtato example with HTTP service lookup ([#113](https://github.com/aepfli/lifecycle-toolkit/issues/113)) ([81b1236](https://github.com/aepfli/lifecycle-toolkit/commit/81b1236dcff7bd37afd0e39f11638fe01406c7c4))
...
* Update manifest name in readme ([#111](https://github.com/aepfli/lifecycle-toolkit/issues/111)) ([e51dbbc](https://github.com/aepfli/lifecycle-toolkit/commit/e51dbbc0198f734fb3905b280bc1ff2e0b24d39e))

...
| `scheduler.scheduler.image.tag`                                                  | set image tag for scheduler <!---x-release-please-version-->   | `v0.2.1`                        |
...
| `certificateOperator.manager.image.tag`                | select tag for manager container <!---x-release-please-version--> | `v0.2.1`                                   |
...
| `lifecycleOperator.manager.env.functionRunnerImage`                           | specify image for task runtime <!---x-release-please-version--> | `ghcr.keptn.sh/keptn/functions-runtime:v0.2.1` |
| `lifecycleOperator.manager.image.repository`                                  | specify registry for manager image                              | `ghcr.keptn.sh/keptn/lifecycle-operator`       |
| `lifecycleOperator.manager.image.tag`                                         | select tag for manager image <!---x-release-please-version-->   | `v0.2.1`                                       |
...
| `metricsOperator.manager.image.tag`                                         | select tag for manager image <!---x-release-please-version--> | `v0.2.1`                               |
